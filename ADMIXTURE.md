...
*~/KoborLab/kobor_space/ppascualli/Files/CRELES/CRELES_GSA/Original/PLINK_290520_0823/CRELES_QC/Global_Ancestry_Analysis/ADMIXTURE/Cross_Val/REF20_CRELES_pc7-cleaned.3.Q*

*~/KoborLab/kobor_space/ppascualli/Files/CRELES/CRELES_GSA/Original/PLINK_290520_0823/CRELES_QC/Global_Ancestry_Analysis/ADMIXTURE/sample_info_files/sample_info_REF20_CRELESpc7.txt*
...
![](ADMIXTURE_files/figure-html/unnamed-chunk-1-1.png)<!-- -->
...
```r
#### ----------------- Unsupervised ADMIXTURE ---------------------- ####
Q <- read.table("/Users/paola.arguello/Documents/UBC/LANGEBIO/ADMIXTURE_files/previous_ref/REF20_CRELES_pc7-cleaned.3.Q")
sample.info <- read.table("/Users/paola.arguello/Documents/UBC/LANGEBIO/ADMIXTURE_files/previous_ref/sample_info_REF20_CRELESpc7.txt")
Q$V4 <- sample.info$V4
...
![](ADMIXTURE_files/figure-html/unnamed-chunk-3-2.png)<!-- -->
...
```
## Using ID, SuperPop, Population as id variables
```
...
![](ADMIXTURE_files/figure-html/unnamed-chunk-9-1.png)<!-- -->
...
![](ADMIXTURE_files/figure-html/unnamed-chunk-9-2.png)<!-- -->
...
## 	Welch Two Sample t-test
## 
## data:  CR$NAT and Nico$NAT
## t = -6.0089, df = 116.47, p-value = 2.189e-08
## alternative hypothesis: true difference in means is not equal to 0
## 95 percent confidence interval:
##  -0.11484773 -0.05790726
## sample estimates:
## mean of x mean of y 
## 0.3689709 0.4553484
```
...
## 	Welch Two Sample t-test
## 
## data:  CR$EUR and Nico$EUR
## t = 11.952, df = 109.19, p-value < 2.2e-16
## alternative hypothesis: true difference in means is not equal to 0
## 95 percent confidence interval:
##  0.1864534 0.2605793
## sample estimates:
...
## 	Welch Two Sample t-test
## 
## data:  CR$AFR and Nico$AFR
## t = -11.192, df = 96.885, p-value < 2.2e-16
## alternative hypothesis: true difference in means is not equal to 0
## 95 percent confidence interval:
##  -0.1614593 -0.1128183
## sample estimates:
##  mean of x  mean of y 
## 0.06014168 0.19728049
```
...
![](ADMIXTURE_files/figure-html/unnamed-chunk-10-1.png)<!-- -->
...
<table class=" lightable-paper lightable-striped" style='font-family: "Arial Narrow", arial, helvetica, sans-serif; margin-left: auto; margin-right: auto;'>
 <thead>
  <tr>
   <th style="text-align:left;"> Nicoyan </th>
   <th style="text-align:left;"> Non.Nicoyan </th>
  </tr>
 </thead>
<tbody>
  <tr>
...
![](ADMIXTURE_files/figure-html/unnamed-chunk-13-1.png)<!-- -->
...
![](ADMIXTURE_files/figure-html/unnamed-chunk-14-1.png)<!-- -->
...
![](ADMIXTURE_files/figure-html/unnamed-chunk-15-1.png)<!-- -->
...
![](ADMIXTURE_files/figure-html/unnamed-chunk-15-2.png)<!-- -->
...
## 
## data:  CR$NAT and Nico$NAT
## t = -5.926, df = 117.8, p-value = 3.158e-08
## alternative hypothesis: true difference in means is not equal to 0
## 95 percent confidence interval:
##  -0.11200255 -0.05589559
## sample estimates:
## mean of x mean of y 
## 0.3703293 0.4542783
```
...
## 
## data:  CR$EUR and Nico$EUR
## t = 11.929, df = 110.16, p-value < 2.2e-16
## alternative hypothesis: true difference in means is not equal to 0
## 95 percent confidence interval:
##  0.1845525 0.2580847
## sample estimates:
...
## 
## data:  CR$AFR and Nico$AFR
## t = -11.185, df = 96.783, p-value < 2.2e-16
## alternative hypothesis: true difference in means is not equal to 0
## 95 percent confidence interval:
##  -0.1603813 -0.1120404
## sample estimates:
##  mean of x  mean of y 
## 0.06112594 0.19733680
```
...
## 	Welch Two Sample t-test
## 
## data:  CR$EAS and Nico$EAS
## t = -0.43152, df = 425.22, p-value = 0.6663
## alternative hypothesis: true difference in means is not equal to 0
## 95 percent confidence interval:
##  -0.006436140  0.004118893
## sample estimates:
##   mean of x   mean of y 
## 0.005984426 0.007143049
```
...
![](ADMIXTURE_files/figure-html/unnamed-chunk-16-1.png)<!-- -->
